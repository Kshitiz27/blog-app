...
public class CategoryController {
	...
	@PostMapping("/")
	public ResponseEntity<CategoryDto> createCat(@Validated @RequestBody CategoryDto catdto){
	...
	@PutMapping("/{catId}")
	public ResponseEntity<CategoryDto> updtCat(@Validated @RequestBody CategoryDto catdto, @PathVariable Integer catId){
	...
	public ResponseEntity<CategoryDto> getCat(@PathVariable Integer catId){
		CategoryDto catdto4 = this.categoryserv.getCat(catId);
		return new ResponseEntity<CategoryDto>(catdto4,HttpStatus.OK);
	}
}
